...
public class EmployeeServiceImpl extends ServiceImpl<EmployeeMapper, Employee> implements EmployeeService {
    ...
    @Override
    public Boolean insertNew(EmployeeDTO employeeDTO) {
        Employee employee = new Employee();
        BeanUtils.copyProperties(employeeDTO, employee);
        employee.setPassword("e10adc3949ba59abbe56e057f20f883e");
        boolean isInsert = save(employee);
        return isInsert;
    }

    @Override
    public Result<PageResult> pageOfEmployee(Integer page, Integer pageSize, String name) {
